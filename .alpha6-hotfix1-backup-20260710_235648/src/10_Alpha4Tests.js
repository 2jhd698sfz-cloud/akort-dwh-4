  ...
  function runSmokeTest() {
    return AKORT.Core.safeRun('ALPHA4_SMOKE_TEST', function (context) {
      ...
      tests.push(test_('raw_store_contract', function () {
        require_(['4.0.0-alpha.4', '4.0.0-alpha.5', '4.0.0-alpha.6'].indexOf(AKORT.Release.version) >= 0, 'RELEASE_VERSION_MISMATCH', 'Unexpected release version for alpha.4 compatibility regression.');
