...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input, durable bounded work and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.33 keeps reversal records in RAW_REVERSAL_LOG instead of oversized operation checkpoints, bounds step audit cells, reports callback failures accurately and recovers the exact stopped Alpha.7.4.32 reversal staging checkpoint at UPDATING_AGGREGATES without repeating RAW, price Publish or aggregate calculation; general user publication remains gated until Gate 7',
