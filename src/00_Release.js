...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration: durable aggregate staging, logical-series replacement, lost-response recovery, reconciliation, and disabled-by-default physical publication through the existing Operation Engine',
