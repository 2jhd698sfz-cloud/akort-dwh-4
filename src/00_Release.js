...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.22 installs the accepted Alpha.6 parity calculation adapter behind the Alpha.7.4 atomic logical-series boundary, accepts Config-typed JSON objects without reparsing, and resumes the exact .20 canary from MATERIALIZING_AGGREGATE_INPUTS without repeating RAW or price Publish writes; general user publication remains gated until Gate 7',
