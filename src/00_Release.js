...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with durable chunked aggregate-item inventory preparation, pre-expansion aggregate descriptor deduplication, schema-compatible replay resume, adaptive atomic publication windows, Alpha.6-style bounded target identity scans, affected-series-only reads, appended-tail verification, durable Gate 5 aggregate-batch materialization, staged/publication period-identity repair, exact-duplicate lost-response recovery, preserved full-build reuse and a controlled RAW_INDUSTRY operator form; regular physical publication remains gated',
