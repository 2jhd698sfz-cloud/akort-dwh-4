...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input, durable bounded work and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.32 guarantees compact terminal Gate 6 persistence and permits the exact stopped Alpha.7.4.30 VERIFY_ROLLBACK +196-row checkpoint to enter the bounded canonical weekly recovery without repeating canary or reversal; general user publication remains gated until Gate 7',
