...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.24 preserves mandatory durable bounded work and recognizes the verified lost-response after-state in which all 392 calculated rows were already marked STAGED but no publish intent or target mutation exists, validates the immutable stage snapshot and resumes bounded processing without repeating RAW, price Publish or aggregate calculation; general user publication remains gated until Gate 7',
