...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.6.2.4 markup parity and compare-failure recovery: complete weekly and monthly markup dependency closure, materialize absolute and derived markup series, reuse the verified Full-build row and dynamics contracts, align six-decimal calculation order, normalize the consolidated monthly-index series identity, and resume the preserved reconciliation through cursor-checkpointed markup-only series replacement',
