...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 parity, durable bounded work and Gate 6 authoritative DEV canary; Alpha.7.4.36 introduces the fail-closed Gate 7 acceptance harness for the twelve approved parser profiles and controlled Industry E2E while general user publication remains disabled',
