...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with isolated full-build, sequential-replay and quota acceptance; regular physical publication remains disabled through the existing Operation Engine',
