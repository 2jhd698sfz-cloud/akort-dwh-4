...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.6.1 corrective release: incremental Publish for weekly, monthly and industry marts; compact aggregate impact planning only; three-table triple reconciliation',
