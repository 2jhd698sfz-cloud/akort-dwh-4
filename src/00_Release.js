...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with durable Gate 5 aggregate-batch materialization, staged/publication period-identity repair, exact-duplicate lost-response recovery with conflicting-duplicate fail-closed protection, cursor-preserving replay resume, preserved full-build reuse and a controlled operator form for asynchronous RAW_INDUSTRY period/value submissions through RAW_LOAD_V4; regular physical publication remains gated',
