...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.30 compacts Gate 6 recovery lineage, preserves durable bounded work and terminal fail-closed state under the Script Properties limit, and exactly resumes the stopped Alpha.7.4.29 rollback scan without repeating canary or reversal; general user publication remains gated until Gate 7',
