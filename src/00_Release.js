...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input, durable bounded work and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.34 prevents logical reversal from restoring observations owned by already REVERSED loads and provides an exact bounded repair for the Alpha.7.4.33 Gate 6 RAW-lineage incident before rebuilding price and aggregate Publish from corrected RAW; general user publication remains gated until Gate 7',
