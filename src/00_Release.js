...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input, durable bounded work and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.35 finalizes evidence after the accepted canary has correctly become REVERSED, without replaying the already exact canary, rollback or restore cycle; general user publication remains gated until Gate 7',
