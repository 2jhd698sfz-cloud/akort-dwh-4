...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with accepted Gate 5 full-history parity, controlled RAW_INDUSTRY input and fail-closed Gate 6 authoritative DEV canary; Alpha.7.4.23 enforces durable bounded work for aggregate materialization, stage validation, publication, latest checks, reconciliation and finalization, and resumes the exact stopped .22 canary from STAGING_AGGREGATE_ROWS without repeating RAW, price Publish or aggregate calculation; general user publication remains gated until Gate 7',
