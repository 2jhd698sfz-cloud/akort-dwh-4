...
var AKORT_RELEASE_DEFINITION = {
  ...
  purpose: 'Alpha.7.4 incremental aggregate integration with durable chunked aggregate-item inventory preparation, pre-expansion aggregate descriptor deduplication, schema-compatible replay resume, adaptive atomic publication windows, Alpha.6-style bounded target identity scans, affected-series-only reads, appended-tail verification, durable Gate 5 aggregate-batch materialization, canonical aggregate identifiers and date cells, exact-duplicate lost-response recovery, order-independent reconciliation, terminal Gate 5 artifact reuse and a controlled RAW_INDUSTRY operator form; regular physical publication remains gated',
