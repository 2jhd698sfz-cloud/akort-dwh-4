...
AKORT.Alpha4Tests = (function () {
  ...
  function runContract_(state, config, dwh) {
    var contract = test_('raw_store_contract', function () {
      require_(['4.0.0-alpha.4', '4.0.0-alpha.5', '4.0.0-alpha.6', '4.0.0-alpha.6.2.4', '4.0.0-alpha.7.4', '4.0.0-alpha.7.4.1', '4.0.0-alpha.7.4.2', '4.0.0-alpha.7.4.3', '4.0.0-alpha.7.4.4', '4.0.0-alpha.7.4.5'].indexOf(AKORT.Release.version) >= 0,
